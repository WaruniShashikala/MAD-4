...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val addETPrio = addTaskDialog.findViewById<TextInputEditText>(R.id.edTaskPriority)
        val addETPrioL = addTaskDialog.findViewById<TextInputLayout>(R.id.edTaskPriorityL)

        addETDesc.addTextChangedListener(object : TextWatcher {
            override fun beforeTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {}
            override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {}
            override fun afterTextChanged(s: Editable) {
                validateEditText(addETPrio, addETPrioL)
            }
        })
        ...
        mainBinding.addTaskFABtn.setOnClickListener {
            ...
            clearEditText(addETPrio, addETPrioL)
            addTaskDialog.show()
        }
        val saveTaskBtn = addTaskDialog.findViewById<Button>(R.id.saveTaskBtn)
        saveTaskBtn.setOnClickListener {
            if (validateEditText(addETTitle, addETTitleL)
                && validateEditText(addETDesc, addETDescL) && validateEditText(addETPrio, addETPrioL)
            ) {
